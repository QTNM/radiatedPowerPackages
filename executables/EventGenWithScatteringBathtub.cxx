/*
  EventGenWithScatteringBathtub.cxx

  Generate realistic events with some scattering in a bathtub configuration
*/
...
int main(int argc, char *argv[]) {
  ...
  const double zLimit{trapLength / 2};
  while (nGenerated < nEvents) {
    ...
    double zGen{2 * zLimit * uni1(gen) - zLimit};
    ...
    // Generate the initial direction as a random point on the unit sphere
