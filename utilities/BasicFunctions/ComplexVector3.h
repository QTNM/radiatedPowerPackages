...
#ifndef BASIC_FUNCTIONS_COMPLEX_VECTOR_THREE_H
#define BASIC_FUNCTIONS_COMPLEX_VECTOR_THREE_H
...
class ComplexVector3 {
 ...
 public:
  ...
  ComplexVector3(std::complex<double> x, std::complex<double> y,
...
ComplexVector3 operator*(double& a, ComplexVector3& vec);

/// Multiplication by a complex double
ComplexVector3 operator*(std::complex<double>& a, ComplexVector3& vec);
}  // namespace rad
